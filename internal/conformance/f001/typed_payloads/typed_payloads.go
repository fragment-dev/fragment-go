...
type AuthCaptureV1Entry struct {
	_ struct{}
...
// FragmentBatchEntry marks AuthCaptureV1Entry as usable in a batch.
func (AuthCaptureV1Entry) FragmentBatchEntry() {}
...
func (e AuthCaptureV1Entry) MarshalJSON() ([]byte, error) {
	...
	params.Set("capture_amount", e.CaptureAmount)
